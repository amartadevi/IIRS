(function() {
	...
	var backToTop = function() {
		var btn = document.querySelector('.js-backtotop');
		if (btn) {
	...
	var owlCarousel = function(){
		if (typeof jQuery.fn.owlCarousel === 'undefined') return;

		var owl = jQuery('.owl-carousel-carousel');
		if (owl.length) owl.owlCarousel({
			items: 3,
			loop: true,
			margin: 20,
			nav: false,
		...
		var owl2 = jQuery('.owl-carousel-fullwidth');
		if (owl2.length) owl2.owlCarousel({
			items: 1,
			loop: true,
			margin: 20,
			nav: false,
		...
		var owl3 = jQuery('.owl-work');
		if (owl3.length) owl3.owlCarousel({
			stagePadding: 150,
			loop: true,
			margin: 20,
			nav: true,
	...
	var tabsOwl = function() {
	    ...
	    console.log('owl2 loaded');
		}).on('hide.bs.tab', function () {
	    destroy_owl(jQuery('#owl2'));
		});

		jQuery('a[href="#noticeboard"]').on('shown.bs.tab', function () {
	    initialize_owl(jQuery('#owl3'));
	    console.log('owl3 loaded');
		}).on('hide.bs.tab', function () {
	...
	var flexSlider = function() {
	  if (typeof jQuery.fn.flexslider === 'undefined') return;
	  var fs = jQuery('.flexslider');
	  if (fs.length) fs.flexslider({
	    animation: "fade",
	    prevText: "",
	    nextText: "",
	    slideshow: true
	...
	var contentWayPoint = function() {
		if (typeof jQuery.fn.waypoint === 'undefined') return;
		var i = 0;
	...
	var galleryMasonry = function() {
		// isotope
		if (typeof jQuery.fn.isotope === 'undefined' || typeof jQuery.fn.imagesLoaded === 'undefined') return;
	...
	var magnificPopupControl = function() {
		if (typeof jQuery.fn.magnificPopup === 'undefined') return;
